...
import { codeProperty, colorProperty, customProperty, selectProperty, textProperty } from '@/types/config-properties';
  ...
  configSchema: {
    properties: {
        ...
        customStyle: codeProperty({
            ...
            description: "Additional CSS properties. For floating action button, use: bottom: 40; right: 40; (in pixels)",
            language: "text",
            height: 100
        })
    }
