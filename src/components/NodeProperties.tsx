...
export const NodeProperties: React.FC<NodePropertiesProps> = ({
  ...
  useEffect(() => {
    const loadCredentials = async () => {
      try {
        const openaiCreds =
          await storageManager.getCredentialsByService("openai");
        ...
        return (
          <Stack gap="md">
            <TextInput
              ...
              onChange={(e) =>
                updateNodeData("config.targetSelector", e.target.value)
              }
            />
            ...
            <Select
              ...
              onChange={(value) =>
                updateNodeData("config.componentType", value)
              }
            />
            ...
            <TextInput
              ...
              onChange={(e) =>
                updateNodeData("config.componentText", e.target.value)
              }
            />
            ...
            <Textarea
              ...
              onChange={(e) =>
                updateNodeData("config.componentStyle", e.target.value)
              }
            />
          </Stack>
        );
      ...
      case "get-element-content":
        return (
          <TextInput
            ...
            onChange={(e) =>
              updateNodeData("config.elementSelector", e.target.value)
            }
          />
        );
      ...
      case "copy-content":
        return (
          <TextInput
            ...
            onChange={(e) =>
              updateNodeData("config.sourceSelector", e.target.value)
            }
          />
        );
        ...
        return (
          <Stack gap="md">
            <TextInput
              ...
              onChange={(e) =>
                updateNodeData("config.modalTitle", e.target.value)
              }
            />
            ...
            <Textarea
              ...
              onChange={(e) =>
                updateNodeData("config.modalContent", e.target.value)
              }
            />
          </Stack>
        );
      ...
      case "navigate":
        return (
          <TextInput
            ...
            onChange={(e) =>
              updateNodeData("config.navigateUrl", e.target.value)
            }
          />
        );
